...
export function register(system, quench) {
    quench.registerBatch(`${system}.items.powers`, function ({ describe, it, expect, afterEach, beforeEach }) {
        describe("New power items asPower", function () {
            ...
            describe("with standard power types", function () {
                ...
                it("should have the same summary and description as the item", function () {
                    ...
                    expect(power.description).to.equal("<p>Run super fast from place to place!</p>");
                });
            });
        });
        ...
        describe("Power modifiers", function () {
            ...
            describe("A new power", function () {
                ...
                it("should allow editing adders", async function () {
                    ...
                    await waitOneMoment();
                    this.sheet
                        .find("table.adders > tbody > tr:first-child > td:first-child > input")
                        .val("Green");
                ...
                it("should gracefully handle advantages with negative values", async function () {
                    ...
                    await waitOneMoment();
                    this.sheet
                        .find("table.advantages > tbody > tr:first-child > td:nth-child(2) > input")
                        .val("-2");
                    await this.power.sheet.submit();
                    const power = this.power.asPower;
    ...
    quench.registerBatch(`${system}.items.frameworks.multipowers`, function ({ describe, it, expect, afterEach, beforeEach }) {
        afterEach(build.afterEach);
        describe("A new stand-alone multipower", function () {
            ...
            it("should be a valid Multipower", function () {
                let multipower;
                expect(() => (multipower = this.multipower.asMultipower)).to.not.throw();
        ...
        describe("A new standalone multipower with slots", function () {
            ...
            it("should contain two slots", function () {
                ...
                expect(multipower.slots[0]).to.have.nested.property("power.name", "Morph STR");
                expect(multipower.slots[1]).to.have.nested.property("power.name", "Morph DEX");
            });
        });
        describe("Adding powers to a multipower", function () {
            describe("that is standalone", function () {
                ...
                it("should mark the power as belonging to the framework", async function () {
                    await build.at(this).power().build();
                    await this.multipower.addPower(this.power);
                    expect(this.power.system.power.framework).to.equal(this.multipower.id);
                });
            });
        ...
        describe("Removing powers from a multipower", function () {
            ...
            it("should be an error if the power is not in the multipower", async function () {
                ...
                expect(error)
                    .to.be.an.instanceof(AssertionError)
                    .and.to.have.a.property("message")
                    .that.equals("Cannot remove a power from a framework it isn't a part of");
            });
    ...
    quench.registerBatch(`${system}.items.frameworks.multipowers.sheet`, function ({ describe, it, expect, afterEach, beforeEach }) {
        afterEach(build.afterEach);
    ...
    quench.registerBatch(`${system}.items.frameworks.vpps`, function ({ describe, it, expect, afterEach, beforeEach }) {
        afterEach(build.afterEach);
        ...
        describe("A new standalone vpp with slots", function () {
            ...
            it("should contain two slots", function () {
                ...
                expect(vpp.slots[0]).to.have.nested.property("power.name", "Morph STR");
                expect(vpp.slots[1]).to.have.nested.property("power.name", "Morph DEX");
            });
        });
    ...
    quench.registerBatch(`${system}.items.frameworks.vpps.sheet`, function ({ describe, it, expect, afterEach, beforeEach }) {
        afterEach(build.afterEach);
