...
describe("mechanics/characteristics", function () {
    describe("constants", function () {
        ...
        it("all exist", function () {
            for (const char of allCharacteristics) {
                ...
                expect(characteristics[char]).toBeInstanceOf(characteristics.Characteristic);
            }
        });
    ...
    describe("STR", function () {
        ...
        describe("HTH damage", function () {
            const hthDamage = (str) => STR.derivedAttributes(str)["system.characteristics.str.hthDamage"];
        ...
        describe("lifting weight", function () {
            const liftingWeight = (str) => STR.derivedAttributes(str)["system.characteristics.str.liftingWeight"];
    ...
    describe("PRE", function () {
        ...
        it("should have the same Presence Attack dice as STR would have for HTH damamge", function () {
            for (let i = 0; i < 100; i++) {
                const presenceAttackDice = PRE.derivedAttributes(i)["system.characteristics.pre.presenceAttackDice"];
                const hthDamage = characteristics.STR.derivedAttributes(i)["system.characteristics.str.hthDamage"];
    ...
    describe("SPD", function () {
        describe("phases", function () {
            const phases = (spd) => characteristics.SPD.derivedAttributes(spd)["system.phases"];
