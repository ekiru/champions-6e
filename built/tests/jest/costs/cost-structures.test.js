...
import { Power, PowerCategory, StandardPowerType, } from "../../../src/mechanics/power.js";
...
describe("Power cost structures", function () {
    const blast = (dice) => new Power("Boom", {
    ...
    const flight = (distance, modifier = 0) => new Power("Zoom", {
