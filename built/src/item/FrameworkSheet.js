import { FrameworkModifierScope, PowerAdvantage, PowerLimitation, } from "../mechanics/powers/modifiers.js";
...
export default class FrameworkSheet extends ItemSheet {
    ...
    activateListeners(html) {
        ...
        html.find(".add-slot").click(async function () {
            const power = await Item.create({ name: "New Power", type: "power" }, { parent: item.parent });
